...
export function createIdIndex(data, meta) {
...
/**
 * saves 'data/index.{uuid}.json' with updates to the id index
 * 
 */
export function updateIdIndex(data, meta, changes) {
	const index = {}
...
export function loadIdIndex(uuid=null) {
	let filename
	if (!uuid) {
